'use client'
import { InstagramLogo, WhatsappLogo, MapPin, Globe, GearSix } from "@phosphor-icons/react";
    ...
    <main className="px-4 mb-10">
      <header
        ...
        height={20}
          ...
          alt="profile image"
          className="h-40 w-40 rounded-full border-4 border-solid border-red-500" />
        <section className="mt-10 flex flex-col gap-2 text-center items-center text-white">
          <div className="flex gap-2 items-center">
            <h3 className="text-2xl font-semibold text-zinc-900">Analogicatec</h3>
            <Image width={20} height={20} className="h-7 w-7 " src="/verify.png" alt="" />
          </div>
          <div>
            <span className="flex justify-center max-w-xs gap-1 text-zinc-900">Automatize a gestão de ponto/frequência de seus colaborares, com o uso de softwares em nuvem e equipamentos digital de alta tecnologia.</span>
          </div>
        </section>
      </header>
      ...
      <ProductLinks
            ...
            icon={()=> <Globe width={30} height={30}  className="mr-2 text-red-600"/>}
          />
          <ProductLinks
            Name='Contato Imperatriz-MA'
            href='https://wa.me/5599992178301'
            icon={()=> <WhatsappLogo width={30} height={30}  className="mr-2 text-red-600"/>}
          />
           <ProductLinks
            ...
            icon={()=> <MapPin width={30} height={30}  className="mr-2 text-red-600"/>}
          />
           <ProductLinks
